...
export const featuresHome: FeaturesProps = {
  ...
  header: {
    title: (
      <>
        What you get with <span className="whitespace-nowrap">T lab</span>
      </>
    ),
    subtitle:
  ...
  testimonials: [
    {
      ...
      testimonial: `I'm impressed by the speed and performance of these templates. My website now loads in the blink of an eye, significantly enhancing my visitors' experience. Thanks to T lab, my online business is thriving.`,
      image: {
    ...
    },
    {
      name: 'Silver Jordan',
      job: 'Senior Marketer',
      testimonial: `I had never found it so easy to customize a website. T lab's templates are incredibly flexible, and with Tailwind CSS, I've managed to give my website the look and feel I always wanted. Highly recommended!`,
      image: {
    ...
    },
    {
      name: 'Lisa Gordon',
      job: 'Project Manager',
      testimonial: `Their templates are not only stunning but also user-friendly. The support I received from their community has been exceptional. I'm proud to say that I've built my dream website with T lab.`,
      image: {
