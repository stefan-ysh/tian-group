...
// Use the Icon type exported from @tabler/icons-react (available in v3.0+)
// This ensures compatibility with Tabler Icons v3.0+ type definitions
type Icon = TablerIconType;
