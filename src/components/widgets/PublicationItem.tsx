...
export const PublicationItem = ({ title, image, slug, publishDate, link, author, journal, journalShort }: PublicationItemProps) => {
      ...
      <div className="w-full md:w-11/12 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between pr-1">
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs block sm:hidden" title={journal}>{journalShort}</span>
          </div>
          <div className="flex items-center gap-1">
            <Calendar size={16} />
