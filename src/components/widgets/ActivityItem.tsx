...
export const ActivityItem = ({ 
  ...
  return (
    <Link href={`/activities/${id}`} className="block h-full">
      <Card
        className="group flex h-full w-full flex-col overflow-hidden border border-gray-100 bg-white transition-all duration-300 hover:shadow-2xl dark:border-gray-700/50 dark:bg-gray-800/50"
        shadow="none"
      >
        ...
        <div className="p-5 flex flex-col flex-grow bg-gradient-to-b from-white to-gray-50/30 dark:from-transparent dark:to-transparent">
          ...
          <div className="pt-3 border-t border-gray-100 dark:border-gray-700/50 flex items-center justify-between text-xs font-medium text-gray-400">
            ...
            <span className="inline-flex items-center gap-1 text-purple-600 opacity-0 transition-opacity group-hover:opacity-100 dark:text-purple-400 font-bold">
              {t('viewDetails')}
