...
export default function ResearchPage() {
  ...
  return (
    <div className="container mx-auto max-w-5xl p-0 md:px-4 md:py-12">
      <BreadcrumbSchema
        items={[
          { name: '首页', url: siteUrl },
          { name: '研究方向', url: `${siteUrl}/research` },
        ]}
      />
      {/* 页面标题 */}
      ...
      <div>
        <div className="space-y-16">
          {/* 钙钛矿光伏材料与器件 */}
          <section>
            <div className="academic-panel p-5 pl-6 md:p-8 md:pl-10">
              <h2 className="academic-section-title">{t('perovskiteTitle')}</h2>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-4">
                  <p className="text-foreground/90 leading-relaxed">{t('perovskiteDescription')}</p>

                  <h3 className="academic-kicker mb-3 mt-6">{t('researchContent')}</h3>
                  <ul className="ml-2 list-disc list-inside space-y-3 text-foreground/90">
                    <li className="pl-2">
          ...
          <section>
            <div className="academic-panel p-5 pl-6 md:p-8 md:pl-10">
              <h2 className="academic-section-title">{t('nonlinearTitle')}</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                  <p className="text-foreground/90 leading-relaxed">{t('nonlinearDescription')}</p>
          ...
          <section>
            <div className="academic-panel p-5 pl-6 md:p-8 md:pl-10">
              <h2 className="academic-section-title">{t('luminTitle')}</h2>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-4">
                  <p className="text-foreground/90 leading-relaxed">{t('luminDescription')}</p>
          ...
          <section>
            <div className="academic-panel p-5 pl-6 md:p-8 md:pl-10">
              <h2 className="academic-section-title">{t('spectroTitle')}</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                  <p className="text-foreground/90 leading-relaxed">{t('spectroDescription')}</p>
          ...
          {/* 小结 */}
          <div className="academic-callout p-6">
            <h3 className="font-serif text-xl font-semibold text-foreground mb-4">{t('outlookTitle')}</h3>
            <p className="text-foreground/80 leading-relaxed">{t('outlookContent')}</p>
          </div>
        </div>
      </div>
    </div>
